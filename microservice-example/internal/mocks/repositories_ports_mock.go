...
func (m *MockCountriesRepositoryPort) GetCountries(ctx context.Context) ([]domain.Country, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCountriesRepositoryPortMockRecorder) GetCountries(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCountries", reflect.TypeOf((*MockCountriesRepositoryPort)(nil).GetCountries), ctx)
}
